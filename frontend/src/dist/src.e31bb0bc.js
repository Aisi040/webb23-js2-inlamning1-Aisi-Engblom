...
var currentScore = 0; // Tracks the current score of the player.
var currentPlayerName = ''; // Holds the name of the player.
...
function playRound(playerChoice) {
  ...
  var computerChoice = choices[Math.floor(Math.random() * 3)]; // Randomly selects computer's choice.
  ...
  } else if (playerChoice === 'sten' && computerChoice === 'sax' || playerChoice === 'sax' && computerChoice === 'påse' || playerChoice === 'påse' && computerChoice === 'sten') {
    currentScore++;
...
function GetHighscores() {
  fetch('http://localhost:3000/highscores').then(function (response) {
    ...
    data.forEach(function (entry) {
      ...
      li.textContent = "".concat(entry.name, ": ").concat(entry.score);
